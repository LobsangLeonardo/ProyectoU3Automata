...
const Page = () => {
  ...
  return (
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div id='ejerc'>
        <h1 className='text-center p-5 text-2xl text-violet-500' style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
          Automata Finito Determinista: 04
        </h1>
      </div>

      <p className='text-center'>
      Un DFA que acepte todas las cadenas que contengan la palabra aabb.
      </p>
